 ...
 */
class CNabuCMSPluginSiteRoleAjax extends CNabuHTTPSiteTargetPluginAdapter
{
    ...
    public function prepareTarget()
    {
        ...
        if (is_array($fragments) && count($fragments) === 3 && is_numeric($fragments[1])) {
            ...
            if ($this->nb_edit_site instanceof CNabuSite) {
                $this->nb_edit_site->refresh(true, true);
                if (is_numeric($fragments[2])) {
                    ...
                    $this->nb_edit_site_role->refresh(true, true);
                }
            }
        }
    ...
    public function beforeDisplayTarget()
    {
        ...
        if ($render instanceof CSmartyHTTPRender) {
            ...
            $render->smartyAssign('edit_role', $this->nb_edit_role, $this->nb_language);
            $render->smartyAssign('edit_site_role', $this->nb_edit_site_role, $this->nb_language);
