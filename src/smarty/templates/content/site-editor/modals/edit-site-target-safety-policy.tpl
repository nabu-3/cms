            ...
            {nabu_modal_body}
                <div class="row">
                    ...
                    <section class="col-sm-9 col-sm-offset-3" data-toggle="toggable-lang">
                        {nabu_raw_assign}
                            sel_options: [
                                P: "{nabu_static key=sel_private_access}"
                                O: "{nabu_static key=sel_public_access}"
                                B: "{nabu_static key=sel_overall_access}"
                            ]
                        {/nabu_raw_assign}
                        {nabu_form_row}
                            {nabu_form_select class="col-sm-4" label={nabu_static key=lbl_access} from=$edit_site_target field=zone options=$sel_options}
