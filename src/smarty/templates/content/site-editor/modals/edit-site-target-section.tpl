            ...
            {nabu_modal_body}
                {nabu_form_row}
                    ...
                    <section class="col-sm-9 col-sm-offset-3" data-toggle="toggable-lang">
                        ...
                        {nabu_form_textbox label={nabu_static key=lbl_image} from=$edit_site_target_section field=main_image multilang=$edit_site.languages help="Escribe la URL de imagen principal de la sección."}
