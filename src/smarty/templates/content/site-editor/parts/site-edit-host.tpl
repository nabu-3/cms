                    ...
                    <div class="col-sm-12 col-md-12">
                        ...
                        <div class="form-inline form-group">
                            <div class="input-group">
                                {strip}
                                    <span class="input-group-addon"><input type="checkbox" name="http_support"{if $edit_site.http_support==='T'} checked{/if} aria-label="HTTP" value="T" data-uncheck-value="F"></span>
                                    <p class="form-control-static">HTTP</p>
                                {/strip}
                            </div>
                            <div class="input-group">
                                {strip}
                                    <span class="input-group-addon"><input type="checkbox" name="https_support"{if $edit_site.https_support==='T'} checked{/if} aria-label="HTTPS" value="T" data-uncheck-value="F"></span>
